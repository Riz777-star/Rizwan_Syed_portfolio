...
import { Send, CheckCircle, AlertCircle, Loader2, ArrowUpRight, Sparkles, HelpCircle, MessageSquare, ExternalLink, Github, Linkedin, Instagram, ChevronDown } from 'lucide-react';
...
function ContactForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('https://formsubmit.co/ajax/syedsrizwansr@gmail.com', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...formData,
                    _subject: `New portfolio message: ${formData.subject || 'Portfolio contact'}`,
                    _template: 'table',
                    _captcha: 'false',
                }),
            });
