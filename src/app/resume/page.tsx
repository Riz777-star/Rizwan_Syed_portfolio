...
const PdfViewer = dynamic(
    ...
    {
        ssr: false,
        loading: () => <div className="w-full h-full animate-pulse bg-muted/40" />,
    }
);
        ...
        <div className="h-screen bg-background relative flex flex-col pt-24 pb-4 overflow-hidden">
            ...
            >
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a
                        href={resumeUrl}
                        download="Rizwan-Syed-Resume.pdf"
                        className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-all active:scale-95 shadow-sm"
                    >
