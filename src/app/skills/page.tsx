...
function FloatingTechBubbles({ mouseX, mouseY }: { mouseX: any, mouseY: any }) {
    const bubbles = [
        { icon: "/skills/windows.svg", label: "Windows Server", top: "15%", left: "8%", delay: 0.2 },
        { icon: "/skills/azure.svg", label: "Microsoft Azure", top: "28%", left: "20%", delay: 1.5 },
        { icon: "/skills/paloalto.svg", label: "Palo Alto", top: "45%", left: "6%", delay: 0.7 },
        { icon: "/skills/powershell.svg", label: "PowerShell", top: "62%", left: "18%", delay: 2.4 },
        { icon: "/skills/linux.svg", label: "Linux", top: "78%", left: "10%", delay: 1.1 },
        { icon: "/skills/aws.svg", label: "AWS", top: "18%", right: "12%", delay: 0.4 },
        { icon: "/skills/sentinelone.svg", label: "SentinelOne", top: "35%", right: "22%", delay: 1.8 },
        { icon: "/skills/vmware.svg", label: "VMware", top: "52%", right: "10%", delay: 1.3 },
        { icon: "/skills/sqlserver.svg", label: "SQL Server", top: "68%", right: "24%", delay: 2.8 },
        { icon: "/skills/python.svg", label: "Python", top: "82%", right: "15%", delay: 0.9 },
    ];
                    ...
                    <div className="max-w-7xl mx-auto relative z-10 w-full mt-12 md:mt-16">
                        <div className="relative w-full flex flex-col justify-center items-center mb-0">
                            <ArchedTechIconsInteractive
                                ...
                                icons={portfolioData.techStack.map(t => t.icon)}
                            />
                            ...
                            >
                                ...
                                <p className="text-sm md:text-base text-muted-foreground leading-relaxed pt-2">
                                    Securing and operating enterprise systems with proven infrastructure, networking, cloud, automation, and research technologies.
                                </p>
                            </motion.div>
                        </div>
