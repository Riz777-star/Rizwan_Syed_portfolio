            ...
            >
                ...
                <div className="relative z-10 flex items-center gap-4 sm:gap-8 py-6 sm:py-10 px-4 sm:px-8">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-muted-foreground text-sm sm:text-base line-clamp-2 max-w-3xl leading-relaxed hidden sm:block">
                            {project.description}
                        </p>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-10 md:p-14 z-30">
                        ...
                        >
                            ...
                            <span className={cn(
                                ...
                                {project.status === 'planned' ? 'Planned' : isOngoing ? 'In Development' : 'Completed'}
                            </span>
                        </motion.div>
                ...
                >
                    ...
                    <div className="flex items-start justify-between gap-4 mb-3">
                        ...
                        <div className="shrink-0 mt-1 sm:mt-2">
                            {(() => {
                const categoryText = project.category || (project.status === 'planned' ? 'Planned' : isOngoing ? 'In Development' : 'Completed');
...
export default function ProjectsPage() {
    ...
    const products = useMemo(() => {
        return portfolioData.projects.slice(0, 10).map((p) => ({
            title: p.title,
            link: `/projects/${p.slug}`,
            thumbnail: p.image ?? getPlaceholderImageUrl(p.title),
        }));
    }, []);
    ...
    const filters: { key: FilterType; label: string }[] = [
        ...
        { key: 'planned', label: t('filters.planned') },
