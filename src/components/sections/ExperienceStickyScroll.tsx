    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* University at Buffalo Box (Left) */}
                <motion.div
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500 group-hover:translate-x-1">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Master's Degree • Graduated Dec 2024</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">University at Buffalo</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            M.S. in Computer Science at SUNY Buffalo. Graduate coursework in database systems, distributed systems, and machine learning. Built Taco-DB — a working C++ relational database engine — plus an on-device iOS real-time object detection app (ResNet50 → TFLite → Core ML).
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center transition-transform duration-500 group-hover:scale-105">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["M.S. CS", "SUNY Buffalo", "Taco-DB"].map(s => (
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-blue-500/50 transition-colors">Graduate Systems Track</p>
                        </div>
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">Bachelor's Degree • Published Author</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">Sathyabama Institute</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            B.E. in Computer Science & Engineering, Chennai, India. Final-year project on real-time mask detection + social distancing (CNN + YOLOv3) was published in IRJMETS, Volume 05 Issue 03, March 2023.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["B.E. CSE", "Chennai", "IRJMETS 2023"].map(s => (
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-orange-500/50 transition-colors">Foundational Engineering</p>
                        </div>
                    </div>
                </motion.div>
