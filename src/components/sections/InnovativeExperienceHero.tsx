...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'University at Buffalo', description: 'M.S. in Computer Science (Dec 2024) — SUNY.', orbitIndex: 0, position: 0.1, imageUrl: "/logos/university-at-buffalo.jpg" },
        { label: 'Sathyabama Institute', description: 'B.E. in Computer Science & Engineering — Chennai, India.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'CISSP', description: 'ISC2 Certified Information Systems Security Professional (Jul 2026).', orbitIndex: 0, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'AWS SAA', description: 'AWS Certified Solutions Architect – Associate (Feb 2025).', orbitIndex: 1, position: 0.65, imageUrl: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'MS WSHA', description: 'Microsoft Certified: Windows Server Hybrid Administrator.', orbitIndex: 0, position: 0.85, imageUrl: "https://images.unsplash.com/photo-1633419461186-7d40a38105ec?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'RHCE', description: 'Red Hat Certified Engineer — Linux automation with Ansible.', orbitIndex: 1, position: 0.05, imageUrl: "https://images.unsplash.com/photo-1580927752452-89d86da3fa0a?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    journey: [
        { label: 'Systems Admin Track', description: 'Vaya Group → University at Buffalo → Holiday Channel → Koike Aronson.', orbitIndex: 0, position: 0.15, imageUrl: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'HPC at UB', description: 'Compute clusters, NFS, research workload performance tuning.', orbitIndex: 1, position: 0.35, imageUrl: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Enterprise Networking', description: 'Palo Alto, Dell SONiC, VLAN architecture, PoE and segmentation.', orbitIndex: 0, position: 0.55, imageUrl: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Virtualization', description: 'VMware vSphere (100+ VMs, HA/DRS) and Hyper-V in production.', orbitIndex: 1, position: 0.75, imageUrl: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Backup & DR', description: 'Veeam design, monitoring, failover testing across sites.', orbitIndex: 0, position: 0.9, imageUrl: "https://images.unsplash.com/photo-1600267204091-5c1ab8b10c02?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Hybrid Identity', description: 'AD + Entra ID, Intune, Exchange Online, Microsoft 365.', orbitIndex: 1, position: 0.02, imageUrl: "https://images.unsplash.com/photo-1633419461186-7d40a38105ec?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    experience: [
        { label: 'Adaptive Zero Trust', description: 'Contextual risk scoring with explainable access decisions.', orbitIndex: 0, position: 0.2, imageUrl: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Self-Healing Defense', description: 'Closed-loop detection, response, recovery, and adaptation.', orbitIndex: 1, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Immutable Recovery', description: 'Isolated backup security with integrity-tested restoration.', orbitIndex: 0, position: 0.6, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Contextual Access', description: 'Hybrid RBAC and ABAC for dynamic enterprise authorization.', orbitIndex: 1, position: 0.8, imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Recovery Planning', description: 'Dependency-aware restoration with validation gates.', orbitIndex: 0, position: 0.95, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Policy Analytics', description: 'Role mining, privilege analysis, and policy simulation.', orbitIndex: 1, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ]
};
