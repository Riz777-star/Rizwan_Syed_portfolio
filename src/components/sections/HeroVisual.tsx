      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10 max-w-[105rem] w-full mx-auto">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Hi, I'm {personal.name}. I secure and operate enterprise infrastructure.
            </motion.p>
            ...
            <div className="relative">
              ...
              >
                ...
                <div
                  ...
                  onClick={() => window.open(portfolioData.personal.socialLinks.find(s => s.platform === 'LinkedIn')?.url || '#', '_blank')}
                  onMouseEnter={(e) => setTooltip({ show: true, text: "View on LinkedIn", icon: 'zap', x: e.clientX, y: e.clientY })}
          ...
          {/* Line 3: ADMIN [ICON] ISTRATOR */}
          <div className="md:flex gap-8 items-center relative">
            <motion.h1
              initial={{ opacity: 0, y: 30 }}
              animate={isExiting ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
              transition={{ duration: 1.2, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
              className="text-[clamp(2.65rem,9vw,10rem)] md:flex items-center font-black leading-[0.85] tracking-tighter text-shiny will-change-transform px-4"
            >
              <span>ADMIN</span>
              <div
                ref={botRef}
          ...
          {showProfile && (
            ...
            >
              <ProfileCard
                ...
                description={`${personal.name} secures and operates enterprise infrastructure across networks, servers, identity, endpoints, cloud services, and internal platforms. He combines hands-on administration with security monitoring and automation.`}
