    ...
    const items = [
        {
            ...
            description: "A comprehensive matrix of my technical arsenal — enterprise systems, virtualization, networking, security, SQL Server, and infrastructure automation.",
            href: "/skills",
            icon: Cpu
        },
        {
            ...
            description: "A detailed timeline of my evolution across Vaya Group, University at Buffalo, Holiday Channel, and Koike Aronson — six years of enterprise infrastructure work.",
            href: "/experience",
            icon: Briefcase
        },
        {
            ...
            description: "Ten detailed, vendor-neutral systems covering Zero Trust, autonomous defense, resilient storage, identity governance, and authorization.",
            href: "/projects",
            icon: Rocket
        },
        {
