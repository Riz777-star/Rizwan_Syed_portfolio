...
export const IdentitySequence = ({ scrollYProgress, isVisible }: IdentitySequenceProps) => {
    ...
    const photoScale = useTransform(localProgress, [0.3, 0.8], [1.04, 1], { ease: easeInOut });
        ...
        <div className="relative w-screen h-full flex flex-col items-center justify-center overflow-hidden bg-background dark:bg-black">
            ...
            >
                ...
                >
                    ...
                    <div className="relative w-full h-[110vh] flex flex-col items-center flex-shrink-0 px-2 md:px-4 lg:px-8">
                        {/* Sizing wrapper - not clipped */}
                        <div
                            onMouseEnter={() => setIsHovered(true)}
                            onMouseLeave={() => setIsHovered(false)}
                            className="relative w-full h-full max-w-[1700px] group/photo cursor-pointer"
                        >
                                    ...
                                    <div className="absolute inset-0">
                                        ...
                                        <div className="absolute inset-0">
                                            <motion.div className="relative h-full w-full">
                                                {/* Soft background fill preserves the large cinematic frame
                                                    without sacrificing any part of the vertical portrait. */}
                                                <Image
                                                    src={portfolioData.personal.avatar}
                                                    alt=""
                                                    fill
                                                    aria-hidden="true"
                                                    className="object-cover object-top scale-105 blur-2xl opacity-30"
                                                    sizes="100vw"
                                                    priority
                                                />
                                                <Image
                                                    ...
                                                    alt="Profile"
                                                    fill
                                                    className="object-contain object-center grayscale-0 z-10"
