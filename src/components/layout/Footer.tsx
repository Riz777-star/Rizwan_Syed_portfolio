                                        ...
                                        return (
                                            <Fragment key={social.platform}>
                                                {social.platform === 'Twitter' && (
                                                    <motion.a
                                                        href={portfolioData.personal.socialLinks.find(s => s.platform === 'LinkedIn')?.url || '#'}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                ...
                                <div className="flex-1 flex flex-col justify-center max-w-[1600px] w-full mx-auto relative">
                                    ...
                                    <div className="w-full grid grid-cols-4 gap-x-[5vw] gap-y-[4vh]">
                                        ...
                                        <FooterColumn title={t('socials')}>
                                            ...
                                            <FooterLink href={portfolioData.personal.socialLinks.find(s => s.platform === 'Credly')?.url || '#'} target="_blank">Credly</FooterLink>
                                        </FooterColumn>
