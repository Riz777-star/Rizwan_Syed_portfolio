...
// TODO: set to Rizwan's Kaggle handle when provided.
// This component is currently not rendered in AboutSection — re-enable there
// after setting a real handle and the KAGGLE_API_TOKEN env var.
const KAGGLE_USER = "";
